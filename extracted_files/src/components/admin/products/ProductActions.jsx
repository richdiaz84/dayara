    ...
    const ProductActions = ({ onAddProduct, onRefreshProducts, searchTerm, setSearchTerm, isLoading }) => {
      return (
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
          ...
          <div className="flex gap-2 flex-wrap w-full sm:w-auto">
            ...
            <Button onClick={onRefreshProducts} variant="outline" disabled={isLoading}>
